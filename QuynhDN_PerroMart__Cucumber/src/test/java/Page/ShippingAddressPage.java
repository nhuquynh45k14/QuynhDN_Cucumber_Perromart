...
public class ShippingAddressPage {
    ...
    public void inputAddress(String email, String firstName, String lastName, String address, String apartment, String postalCode, String phone) {
        txtEmail.sendKeys(email);
        txtFirstName.sendKeys(firstName);
        txtLastName.sendKeys(lastName);
        txtAddress.sendKeys(address);
        txtApartment.click();
        txtApartment.sendKeys(apartment);
